              ...
              <div class="col-xl-8 col-lg-8">
                <div class="box_general_3 cart">
                  ...
                  <div class="step">
                    ...
                    <p>
                      <img src="../../assets/img/paypal_bt.png" alt="" />
                    </p>
                  </div>
                  <hr />
                  {/* <!--End step --> */}
                ...
                <div class="box_general_3 booking">
                  <form>
                    ...
                    <div class="summary">
                      <ul>
                        <li>
                          Date: <strong class="float-right">11/12/2017</strong>
                        </li>
                        <li>
                          Time: <strong class="float-right">10.30 am</strong>
                        </li>
                        <li>
                          Dr. Name:{" "}
                          <strong class="float-right">Dr. julia Jhones</strong>
                        </li>
                      </ul>
                    </div>
                    <ul class="treatments checkout clearfix">
                      ...
                      <li>
                        ...
                        <strong class="float-right">$55</strong>
                      </li>
                      <li class="total">
                    ...
                    <hr />
                    <a href="0#" class="btn_1 full-width">
                      Confirm and pay
                    </a>
                  </form>
                </div>
